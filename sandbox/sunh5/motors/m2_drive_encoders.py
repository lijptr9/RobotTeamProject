...
Authors: David Fisher and HaoxuanSun.
"""  # DONE: 1. Haoxuan Sun.
...
def main():
    ...
    length = int(input('Please input Length traveled in inches'))
    speed = int(input('Please input speed in degrees per second'))
    right_motor.run_to_rel_pos(position_sp=length * 90, speed_sp=speed)
    left_motor.run_to_rel_pos(position_sp=length * 90, speed_sp=speed)
